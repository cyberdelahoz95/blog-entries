...
En este algoritmo el valor de K corresponde al número de vecinos necesarios para que un vector o data point se le asigna la clase o etiqueta 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4NDExNjczMSwtNTkwNzAwMjgwLDE1NT
