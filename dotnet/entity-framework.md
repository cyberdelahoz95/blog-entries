...
Podemos notar varios detalles, 
 ...
 - En este caso, debido a que los nombres de los campos en la base de datos no son exactamente iguales a nuestras propiedades, nos valemos de data annotations para configurar el comportamiento deseado. En este caso, la anotación Column nos ayuda con ese propósito. La anotación Table, hace lo propio al indicar el mapping de los registros contra esta clase Product.

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NzUzNjg4NjksNjE2OTU2NTkzXX0=
-->